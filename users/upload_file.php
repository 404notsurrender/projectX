...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadSuccess) {
        // File uploaded successfully, update user's balance
        $userId = $_SESSION['user_id'];
        $amountToAdd = 0.013;

        // Update user's balance
        updateBalance($userId, $amountToAdd, $conn);

        // Save file information to database
        $fileName = $_FILES["uploadedFile"]["name"];
        $filePath = $uploadedFile;
        saveFileInfoToDatabase($userId, $fileName, $filePath, $conn);
        $query = "INSERT INTO files (user_id, file_name, file_path, upload_by) VALUES ('$userId', '$fileName', '$filePath', '$username')";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">Project <sup>X</sup></div>
            </a>
            ...
            <li class="nav-item">
            <a class="nav-link" href="<?php echo "upload_file.php"; ?>">
                    <i class="fas fa-fw fa-upload"></i>
                    <span>Upload File</span>
                </a>
                <a class="nav-link" href="<?php echo "view_files.php"; ?>">
            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">File Upload</h1>
                        <div class="col mb-4">
                                    ...
                                    <?php if (isset($_SESSION['user_id'])) : ?>
                                        <div class="text-white-100 small">
                                            <marquee behavior="scrolling" direction="left">
                                                ...
                                                Silahkan upload file anda disini!
                                            </marquee>
                                        </div>
                                    <?php endif; ?>
                                </div>
...
if (isset($uploadSuccess) && $uploadSuccess) {
    echo '<div class="col-lg-6 mb-4">
            <div class="card bg-success text-white shadow">
                <div class="card-body">
                    File berhasil diunggah. Saldo Anda sekarang diperbarui. Terima kasih!
                </div>
            </div>
        </div>';
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control-file" id="file" name="uploadedFile" required>
                                            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <a href="http://mdz.my.id" target="_blank" rel="noopener noreferrer">Project X</a> 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
