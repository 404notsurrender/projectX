...
<!-- Konten dashboard sesuai level user -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
            <a class="nav-link" href="<?php echo "users/upload_file.php"; ?>">
                    <i class="fas fa-fw fa-upload"></i>
                    <span>Upload File</span>
                </a>
                <a class="nav-link" href="<?php echo "users/view_files.php"; ?>">
                ...
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Level</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $_SESSION['level']; ?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <?php elseif ($_SESSION['level'] === 'reseller') : ?>
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Member</h6>
                                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <a href="http://mdz.my.id" target="_blank" rel="noopener noreferrer">Project X</a> 2024 All rights Reserved. Created by 💖</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
